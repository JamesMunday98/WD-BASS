...
class load_models(object):
	...
	def load_models_DA_AntoineNLTE(minwl=3000,maxwl=8000):
		cwd="/home/james/python_scripts_path/dwd_fit_package/Antoine_NLTE"
	...
	def load_models_DA_3D_NLTE(minwl=3000,maxwl=8000, toConvolve=True):
		try: 
			#raise ValueError
			wl_all, flux, Teff, Grav = np.load("/home/james/python_scripts_path/dwd_fit_package/saved_grids_npy/DA_3D_NLTE.npy")
			...
			if saveit==True:
				np.save("/home/james/python_scripts_path/dwd_fit_package/saved_grids_npy/DA_3D_NLTE.npy", np.array([wl_all_3Dp, flux_3Dp, Teff_3Dp, Grav_3Dp]))
	...
	def load_models_DA_pier_3D_new(minwl=3000,maxwl=8000, toConvolve=True):
		cwd="/home/james/python_scripts_path/dwd_fit_package/Pier_new_3d"
		...
		flux, Teff, Grav=[], [], []
		try: 
			wl_all, flux, Teff, Grav = np.load("/home/james/python_scripts_path/dwd_fit_package/saved_grids_npy/load_models_DA_pier_3D_new.npy")
			maskwl = (wl_all<maxwl) & (wl_all>minwl)
			return wl_all[maskwl], flux[maskwl], Teff[maskwl], Grav[maskwl]
		except:
			saveit=True
		...
		if saveit==True:
			np.save("/home/james/python_scripts_path/dwd_fit_package/saved_grids_npy/load_models_DA_pier_3D_new.npy", np.array([wl_all, flux, Teff, Grav]))
		return wl_all, flux, Teff, Grav
